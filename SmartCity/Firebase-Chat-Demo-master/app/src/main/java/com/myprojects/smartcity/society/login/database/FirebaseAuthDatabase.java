...
public class FirebaseAuthDatabase implements AuthDatabase {
    ...
    private Authentication authenticationFrom(FirebaseUser currentUser) {
        ...
        return new Authentication(new User(currentUser.getUid(), currentUser.getDisplayName(),currentUser.getDisplayName(), photoUrl == null ? "" : photoUrl.toString(), currentUser.getEmail()));
    }
