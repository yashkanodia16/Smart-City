package com.myprojects.smartcity.society.navigation;
...
import com.myprojects.smartcity.society.ClimaCon;
import com.myprojects.smartcity.society.Dependencies;
import com.myprojects.smartcity.society.GirlGuide;
import com.myprojects.smartcity.society.MemberBillMainActivity;
import com.myprojects.smartcity.society.R;
import com.myprojects.smartcity.society.conversation_list.ConversationListFragment;
import com.myprojects.smartcity.society.global.GlobalFragment;
import com.myprojects.smartcity.society.login.LoginActivity;
import com.myprojects.smartcity.society.firstlogin.UserFirstLoginActivity;
import com.myprojects.smartcity.society.profile.ProfileActivity;
import com.myprojects.smartcity.society.user.UsersFragment;
...
public  void toMemberBill(){
    activity.startActivity(new Intent(activity,MemberBillMainActivity.class));

}
    public  void toGirlGuide(){
        activity.startActivity(new Intent (activity,GirlGuide.class));
    }

    public  void toClimaCon(){
        activity.startActivity(new Intent (activity,ClimaCon.class));
    }
