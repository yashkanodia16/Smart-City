package com.myprojects.head.societymanager.user.data_model;
...
public class User implements Parcelable {
    ...
    public User(String id, String name,String flat, String image, String email) {
        this.uid = id;
        this.name = name;
        this.name = flat;
        this.image = image;
    ...
    public boolean equals(Object o) {
        ...
        if (flat != null ? !flat.equals(user.flat) : user.flat != null) {
            return false;
