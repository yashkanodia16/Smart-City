package com.myprojects.head.societymanager.firstlogin;
...
import com.myprojects.head.societymanager.Constants;
...
public class UserFirstLoginActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        flatEditText = (EditText) findViewById(R.id.flatEditText);
        ...
        if (firebaseUser.getDisplayName() != null && firebaseUser.getDisplayName().length() > 0)
            flatEditText.setText(firebaseUser.getDisplayName());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.done:
                ...
                if (flatEditText.getText() == null) {
                    Toast.makeText(this,"Flat Number cannot be empty",Toast.LENGTH_SHORT).show();
                    return false;
                }
                ...
                if (firebaseUser != null) {
                    ...
                    values.put(Constants.FIREBASE_USERS_FLAT,flatEditText.getText().toString());
