package com.myprojects.head.societymanager.main.presenter;
...
import com.myprojects.head.societymanager.main.view.MainDisplayer;
import com.myprojects.head.societymanager.navigation.AndroidMainNavigator;
    ...
    private final MainDisplayer.DrawerActionListener drawerActionListener = new MainDisplayer.DrawerActionListener() {
        ...
        public void onNavigationItemSelected(MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.nav_m_bill:
                    navigator.toMemberBill();
                    break;

                case R.id.nav_girl_guide:
                    navigator.toGirlGuide();
                    break;

                case R.id.nav_climacon:
                    navigator.toClimaCon();
                    break;
